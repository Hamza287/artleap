...
class Step1 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    try {
      ...
      final selectedIndex = ref.watch(step1SelectedIndexProvider);
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: GestureDetector(
                      onTap: () => ref
                          .read(step1SelectedIndexProvider.notifier)
                          .state = index,
                      child: Container(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: selectedIndex == null
                    ...
                    : () {
                        ref
                            .read(interestOnboardingStepProvider.notifier)
                            .state++;
                      },
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ElevatedButton(
                onPressed: () => ref.refresh(step1SelectedIndexProvider),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF875EFF),
                ),
                child: Text(
