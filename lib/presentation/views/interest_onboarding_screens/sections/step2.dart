...
class Step2 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    try {
      ...
      final selectedIndex = ref.watch(step2SelectedIndexProvider);
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: GestureDetector(
                      onTap: () => ref.read(step2SelectedIndexProvider.notifier).state = index,
                      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ElevatedButton(
                onPressed: () => ref.refresh(step2SelectedIndexProvider),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF875EFF),
                ),
                child: Text(
