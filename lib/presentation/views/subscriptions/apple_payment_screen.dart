...
class _ApplePaymentScreenState extends ConsumerState<ApplePaymentScreen> {
  ...
  @override
  void dispose() {
    // Clean up any pending purchases when screen is disposed
  ...
  Future<void> _handleSubscription() async {
    ...
    if (paymentMethod == 'apple') {
      ...
      // Stop loader if purchase initiation fails or is canceled
      if (!success) {
        ref.read(paymentLoadingProvider.notifier).state = false;
      }
      // If successful, the navigation will be handled by the service
  ...
  // Handle back button press to cancel any pending Apple purchase
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                // Cancel button (only shown when Apple payment is in progress)
