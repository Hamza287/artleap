            ...
            child: Column(
              children: [
                ...
                if (!isLoading && user != null) ...[
                  ...
                  const SizedBox(height: 20),
                  CreditsCard(
                    dailyCredits: user.usedImageCredits + user.usedPromptCredits ,
                    totalCredits: user.totalCredits + user.usedImageCredits + user.usedPromptCredits,
                    usedImageCredits: user.usedImageCredits,
                    imageGenerationCredits: user.totalCredits + user.usedImageCredits + user.usedPromptCredits,
                    usedPromptCredits: user.usedPromptCredits,
                    promptGenerationCredits: user.totalCredits + user.usedImageCredits + user.usedPromptCredits,
                  ),
                  const SizedBox(height: 20),
